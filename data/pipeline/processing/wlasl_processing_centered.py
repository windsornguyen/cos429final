...
if __name__ == '__main__':
    ...
    checkpoint_file = '../../wlasl/landmark_data_centered_chkpt.pkl'
    ...
    with open(
            '/scratch/gpfs/mn4560/final/data/wlasl/wlasl/wlasl_train_centered.json',
            'w',
        ) as f:
    ...
    with open(
        '/scratch/gpfs/mn4560/final/data/wlasl/wlasl/wlasl_val_centered.json',
        'w',
    ) as f:
        json.dump(val_df.to_dict('records'), f, indent=4)
    ...
    with open(
        '/scratch/gpfs/mn4560/final/data/wlasl/wlasl/wlasl_test_centered.json',
        'w',
    ) as f:
